...
function makeType(typename, argnames) {
    var type = Object.create(rootASTNode, {'asttype': {'value': typename}}), // TODO can I make this be enumerated?
        constructor = function typeConstructor() {
            ...
            /*if (true) {
                self.asttype = typename; // TODO this isn't really necessary -- just for debugging
            }*/
